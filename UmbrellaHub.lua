local function Main()
	...
	local MODULE_URLS = {
		...
		KillSay = 'https://raw.githubusercontent.com/Atom1gg/pizda/refs/heads/main/modules/KillSay.lua',
		GrenadeTrajectory = 'https://raw.githubusercontent.com/Atom1gg/pizda/refs/heads/main/modules/GrenadeTrajectory.lua',
		ESP = 'https://raw.githubusercontent.com/Atom1gg/pizda/refs/heads/main/modules/ESP.lua',
	}
	...
	local modules = {
		...
		SilentAim = {instance = nil, enabled = false, settings = {TeamCheck = true, OnlyHead = true, MaxDistance = 1000, }, },
            ...
            settings = {
                ...
                },
                {
                    ...
                    callback = function(color)
                        if modules.BombESP.instance then
                            modules.BombESP.instance.SetColor(color)
                        end
                    end,
                },
                {
                    ...
                    callback = function(s)
                        if modules.BombESP.instance then
                            modules.BombESP.instance.SetTextVisibility(s)
                        end
                    end,
                },
                {
                    ...
                    callback = function(v)
                        if modules.BombESP.instance then
                            modules.BombESP.instance.SetTransparency(v)
                        end
                    end,
                },
            },
	...
	['FOV Changer'] = {
            settings = {
                ...
                },
                {
                    ...
                    default = 90,
                    callback = function(v)
                        if modules.ChangeFOV.instance then
                            modules.ChangeFOV.instance.SetFOV(v)
                        end
                    end,
                },
            },
		...
		['Third Person'] = {
            settings = {
                ...
                },
                {
                    ...
                    default = 5,
                    callback = function(v)
                        if modules.ThirdPerson.instance then
                            modules.ThirdPerson.instance.SetDistance(v)
                        end
                    end,
                },
            },
			...
			['Auto Bhop'] = {
				settings = {
					...
					},
					{
						...
						callback = function(s)
							if modules.AutoBhop.instance then
								modules.AutoBhop.instance.SetStrafeBoost(s)
							end
						end,
					},
					{
						...
						callback = function(v)
							if modules.AutoBhop.instance then
								modules.AutoBhop.instance.SetStrafeMultiplier(v)
							end
						end,
					},
					{
						...
						callback = function(v)
							if modules.AutoBhop.instance then
								modules.AutoBhop.instance.SetStrafeSensitivity(
									v
								)
							end
						end,
